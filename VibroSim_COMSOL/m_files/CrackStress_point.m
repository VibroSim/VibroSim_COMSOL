...
function [normalstress,shearstressmajor,shearstressminor] = CrackStress_point(model,geomtag,cracktag,physicstag,freqidx,stress_point,solutiontag)
...
% Confirm stress_point is close to the crackpos
disp(stress_point)
disp(crackpos)


% Evaluate stress tensor components
[sx,sxy,sxz,sy,syz,sz] = mphinterp(model, ...
						  { [ physicstag '.sx' ], ...
						    [ physicstag '.sxy' ], ...
						    [ physicstag '.sxz' ], ...
						    [ physicstag '.sy' ], ...
